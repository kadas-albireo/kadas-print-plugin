...
class Case(QDialog, Ui_CaseDialog):
    def __init__(self, scene, parent = None):
        ...
        self.exercisedateLE.textChanged.connect(self.valueChanged)
        self.classificationLE.textChanged.connect(self.valueChanged)
        self.exerciseorganisationLE.textChanged.connect(self.valueChanged)
        self.coursetitleLE.textChanged.connect(self.valueChanged)
        self.troopstitleLE.textChanged.connect(self.valueChanged)
        self.codenameLE.textChanged.connect(self.valueChanged)
        self.mapcircumscriptionLE.textChanged.connect(self.valueChanged)
        self.supplementtitleLE.textChanged.connect(self.valueChanged)
        self.scaletitleLE.textChanged.connect(self.valueChanged)
        self.exercisetitleLE.textChanged.connect(self.valueChanged)
        self.documenttitleLE.textChanged.connect(self.valueChanged)
        self.placedateLE.textChanged.connect(self.valueChanged)
