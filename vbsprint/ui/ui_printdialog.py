...
class Ui_PrintDialog(object):
    def setupUi(self, PrintDialog):
        ...
        self.toolButton_layoutManager = QtGui.QToolButton(PrintDialog)
        self.toolButton_layoutManager.setObjectName(_fromUtf8("toolButton_layoutManager"))
    ...
    def retranslateUi(self, PrintDialog):
        ...
        self.toolButton_layoutManager.setText(_translate("PrintDialog", "...", None))
