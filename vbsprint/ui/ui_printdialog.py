...
class Ui_PrintDialog(object):
    def setupUi(self, PrintDialog):
        ...
        self.horizontalLayout_9.addWidget(self.xleftLE)
        ...
        self.horizontalLayout_9.addWidget(self.ytopLE)
        ...
        self.horizontalLayout_10.addWidget(self.xrightLE)
        ...
        self.horizontalLayout_10.addWidget(self.ybottomLE)
