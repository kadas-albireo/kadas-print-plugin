...
#
# Created: Mon Sep 21 11:38:37 2015
...
class Ui_PrintDialog(object):
    def setupUi(self, PrintDialog):
        ...
        self.checkBox_massstabbalken = QtGui.QCheckBox(PrintDialog)
        ...
        self.checkBox_legende = QtGui.QCheckBox(PrintDialog)
        ...
        self.kastenButton = QtGui.QPushButton(PrintDialog)
    ...
    def retranslateUi(self, PrintDialog):
        ...
        self.label_14.setText(_translate("PrintDialog", "Titel:", None))
        self.checkBox_massstabbalken.setText(_translate("PrintDialog", "Massstabbalken", None))
        self.checkBox_legende.setText(_translate("PrintDialog", "Legende", None))
        self.label_15.setText(_translate("PrintDialog", "Koordinatengitter:", None))
        self.label_2.setText(_translate("PrintDialog", "Interval X:", None))
        self.label_3.setText(_translate("PrintDialog", "Interval Y:", None))
        self.checkBox_beschriftung.setText(_translate("PrintDialog", "Beschriftung", None))
        self.kastenButton.setText(_translate("PrintDialog", "Kartenkartusche", None))
